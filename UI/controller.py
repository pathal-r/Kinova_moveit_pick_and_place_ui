...
class GUI(QDialog):
    ...
    def __init__(self,parent=None):
        ...
        self.arm.set_planner_id(self.planner_id)
        self.gripper.set_planner_id(self.planner_id)

    def OMPL_planner(self):
        if self.ui.ompl_checkBox.isChecked:
            self.planner_id = "ompl"
        self.arm.set_planner_id(self.planner_id)
        self.gripper.set_planner_id(self.planner_id)

    def CHOMP_planner(self):
        if self.ui.chomp_checkBox.isChecked:
